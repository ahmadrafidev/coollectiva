...
export const AITools: AITool[] = [
  ...
  { id: 3, name: "AI Code Assistant", description: "Get code suggestions and assistance in various languages.", image: "/images/earth.png", category: "Code", link: "/ai-tools/code-assistant" },
  ...
  { id: 7, name: "AI Music Composer", description: "Generate music from text descriptions.", image: "/images/earth.png", category: "Audio", link: "/ai-tools/music-composer" },
  { id: 8, name: "AI Video Editor", description: "Edit videos using AI-generated suggestions.", image: "/images/earth.png", category: "Video", link: "/ai-tools/video-editor" },
  ...
  { id: 12, name: "AI Chatbot", description: "Automate customer service with an AI-powered chatbot.", image: "/images/earth.png", category: "Service", link: "/ai-tools/chatbot" },
  ...
  { id: 14, name: "AI Marketing Assistant", description: "Get marketing strategies and content suggestions.", image: "/images/earth.png", category: "Marketing", link: "/ai-tools/marketing-assistant" },
  { id: 15, name: "AI Social Media Manager", description: "Manage social media posts and interactions using AI.", image: "/images/earth.png", category: "Marketing", link: "/ai-tools/social-media-manager" },
  ...
  { id: 20, name: "AI Cybersecurity Assistant", description: "Improve your security with AI analysis.", image: "/images/earth.png", category: "Security", link: "/ai-tools/cybersecurity-assistant" },
  { id: 21, name: "AI Facial Recognition", description: "Detect faces in images using AI.", image: "/images/earth.png", category: "Image", link: "/ai-tools/facial-recognition" },
  { id: 22, name: "AI Object Detection", description: "Identify objects in images.", image: "/images/earth.png", category: "Image", link: "/ai-tools/object-detection" },
  ...
  { id: 41, name: "AI Budget Manager", description: "Manage budgets with AI suggestions.", image: "/images/earth.png", category: "Finance", link: "/ai-tools/budget-manager" },
  { id: 42, name: "AI Virtual Assistant", description: "Get personal assistant tasks done with AI.", image: "/images/earth.png", category: "Productivity", link: "/ai-tools/virtual-assistant" },
  { id: 43, name: "AI Virtual Reality Builder", description: "Create VR environments with AI.", image: "/images/earth.png", category: "VR", link: "/ai-tools/vr-builder" },
  { id: 44, name: "AI Photography Assistant", description: "Get photography tips and edits from AI.", image: "/images/earth.png", category: "Image", link: "/ai-tools/photography-assistant" },
  { id: 45, name: "AI Fitness Coach", description: "Receive fitness coaching from AI.", image: "/images/earth.png", category: "Health", link: "/ai-tools/fitness-coach" },
  { id: 46, name: "AI Sleep Tracker", description: "Monitor your sleep patterns with AI.", image: "/images/earth.png", category: "Health", link: "/ai-tools/sleep-tracker" },
  { id: 47, name: "AI Grocery Assistant", description: "Organize grocery lists and meals with AI.", image: "/images/earth.png", category: "Food", link: "/ai-tools/grocery-assistant" },
  { id: 48, name: "AI Virtual Meeting Assistant", description: "Get meeting summaries and notes with AI.", image: "/images/earth.png", category: "Productivity", link: "/ai-tools/meeting-assistant" },
  { id: 49, name: "AI Code Debugger", description: "Find and fix code errors with AI.", image: "/images/earth.png", category: "Code", link: "/ai-tools/code-debugger" },
  { id: 50, name: "AI Email Assistant", description: "Manage and organize emails with AI.", image: "/images/earth.png", category: "Productivity", link: "/ai-tools/email-assistant" },
];
